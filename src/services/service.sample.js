(function () {
                ...
                sources : [
                    {
                        name : "some.name",
                        type : "video/mp4",
                        url  : '../external/media/trailer.mp4'
                    },
                    {
                        name : "some.name",
                        type : "video/ogv",
                        url  : '../external/media/trailer.ogv'
                    },
                    {
                        name : "some.name",
                        type : "video/webm",
                        url  : '../external/media/trailer.webm'
                    }
                ],
                tags : [
                    {
    ...
    var Parser = {
        ...
        load : function ( url, callback, data, scope) {
            setTimeout( function () {
                callback.call(scope, demo, data);
            }, 0);
        }
    };

    Ramp.service("sample", Parser);
