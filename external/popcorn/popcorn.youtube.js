        ...
        var youtubeInit = function() {
            ...
            onYouTubePlayerReady[ container.id ] = function() {
                ...
                onYouTubePlayerReady.onErrorEventHandler[ container.id ] = function( errorCode ) {
                    if ( Popcorn.indexOf([ 2, 100, 101, 150 ], errorCode ) !== -1 ) {
                        media.dispatchEvent( "error" );
                    }
                };

                var listenFn = youtubeObject.addEventListener || youtubeObject.attachEvent;
                // youtube requires callbacks to be a string to a function path from the global scope
                listenFn.call(youtubeObject,"onStateChange", "onYouTubePlayerReady.stateChangeEventHandler." + container.id );

                listenFn.call(youtubeObject,"onError", "onYouTubePlayerReady.onErrorEventHandler." + container.id );
